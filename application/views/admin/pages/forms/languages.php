                        ...
                        <div class="card-body">
                            ...
                            <form class="form-horizontal" id="update-language-form" action="<?= base_url('admin/language/save'); ?>" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="allow_order_attachments" class="control-checkbox">Allow Order Attachments</label>
                                            <input type="text" name="allow_order_attachments" class="form-control" value="<?= (isset($lang_labels['allow_order_attachments']) && !empty($lang_labels['allow_order_attachments'])) ? $lang_labels['allow_order_attachments'] : 'Allow Order Attachments'; ?>" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
