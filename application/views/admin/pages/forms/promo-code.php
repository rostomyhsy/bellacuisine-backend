                        ...
                        <form class="form-horizontal form-submit-event" action="<?= base_url('admin/promo_code/add_promo_code'); ?>" method="POST">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-6">
                                        <label for="is_specific_user"> For specific users? </label>
                                        <div class="card-body">
                                            <input type="checkbox" id="is_specific_user" class="switch" name="is_specific_user" 
                                            
                                            <?= (isset($fetched_details[0]['is_specific_users']) && $fetched_details[0]['is_specific_users'] == '1') 
                                            ? 
                                            'Checked' : ''  ?> 
                                    ...
                                    <div class="col-md-6 promocode_users <?= (isset($fetched_details[0]['is_specific_users']) && $fetched_details[0]['is_specific_users'] == 1) ? '' : 'collapse' ?>" id="promocode_users">
                                        <label for="user_id" class="control-label"> Users</label>
                                    ...
                                    <div class="form-group col-md-6 no_of_users d-none">
